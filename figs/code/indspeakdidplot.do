...
*regressions
reghdfe lnw i.zona_a##ib21397.time $controls if indspeaker==0, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph1
reghdfe lnw i.zona_a##ib21397.time $controls if indspeaker==1, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph2
...
graph export "../output/graph3.png", replace width(4000) height(3000)
