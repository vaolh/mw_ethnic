...
*regressions
reghdfe lni i.zona_a##ib21397.time $controls if indspeaker==0, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph1
reghdfe lni i.zona_a##ib21397.time $controls if indspeaker==1, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph2
...
graph export "../output/graph5.png", replace width(4000) height(3000)
...
*regressions
reghdfe lni i.zona_a##ib21397.time $controls if indigenous==0, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph1
reghdfe lni i.zona_a##ib21397.time $controls if indigenous==1, absorb(ubica_geo time) vce(cluster ubica_geo)
	 eststo graph2
...
xlabel(1 "01feb2016" 2 "01mar2016" 3 "01apr2016" 4 "01may2016" 5 "01jun2016" 6 "01jul2016" 7 "01aug2016" 8 "01sep2016" 9 "01oct2016" ///
      ...
      19 "01feb2020" 20 "01mar2020" 21 "01apr2020" 22 "01may2020" 23 "01jun2020" 24 "01jul2020" 25 "01aug2020" 26 "01sep2020" 27 "01oct2020" ///
      28 "01feb2022" 29 "01mar2022" 30 "01apr2022" 31 "01may2022" 32 "01jun2022" 33 "01jul2022" 34 "01aug2022" 35 "01sep2022" 36 "01oct2022", labsize(medsmall) angle(90))
graph export "../output/graph6.png", replace width(4000) height(3000)
