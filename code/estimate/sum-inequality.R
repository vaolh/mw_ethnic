...
load("../../data/clean/enigh/enigh-indlevel-inc-year.RData")
...
ggsave("../../paper/figures/sum/sum-centile-ictpc.png", width = 10, height = 6)
...
ggplot() +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../../paper/figures/sum/sum-centile-total.png", width = 10, height = 6)
...
ggplot() +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../../paper/figures/sum/sum-proportion-top.png", width = 10, height = 6)
...
ggplot(lorenz_plot_data, aes(x = p, y = lorenz, color = year)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom", legend.title = element_blank())
ggsave("../../paper/figures/sum/sum-lorenz.png", width = 10, height = 6)
