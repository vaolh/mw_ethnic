...
*** REPLICATION FILE: plot-event-wage
...
if "`ds'" == "month" {
    ...
    reghdfe lnw i.zlfn##ib21397.time $controls if indspeaker == 0, ///
        absorb(ubica_geo time) vce(cluster ubica_geo)
    eststo graph1

    reghdfe lnw i.zlfn##ib21397.time $controls if indspeaker == 1, ///
        absorb(ubica_geo time) vce(cluster ubica_geo)
    eststo graph2
    ...
    *************************************************
    ...
    reghdfe lnw i.zlfn##ib21397.time $controls if etnia == 0, ///
        absorb(ubica_geo time) vce(cluster ubica_geo)
    eststo graph3

    reghdfe lnw i.zlfn##ib21397.time $controls if etnia == 1, ///
        absorb(ubica_geo time) vce(cluster ubica_geo)
    eststo graph4
