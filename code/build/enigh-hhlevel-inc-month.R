...
### REPLICATION FILE: enigh-hhlevel-inc-month.R
### R VERSION:        4.5+
### AUTHORS:          Matías Carrasco, Victor Ortega Le Hénanff
### DATE:             2026-05-06

### Builds the household × month ENIGH income panel.
### Parity port of enigh-hhlevel-inc-month.do.
###
...
em <- read_dta("../../data/clean/enigh/enigh-indlevel-inc-month.dta")
em <- as.data.table(em)
...
write_dta_safe(hh_month, "../../data/clean/enigh/enigh-hhlevel-inc-month.dta")
