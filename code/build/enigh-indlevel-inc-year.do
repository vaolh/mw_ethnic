...
*** REPLICATION FILE: enigh-indlevel-inc-year.do
...
***
*** Companion R script: enigh-indlevel-inc-year.R (must produce same N + within 1e-6).

cap mkdir log
log using "log/enigh-indlevel-inc-year.log", replace text
...
compress
save "../../data/clean/enigh/enigh-indlevel-inc-year.dta", replace

display _n "Saved enigh-indlevel-inc-year.dta with " _N " observations and " c(k) " variables."
