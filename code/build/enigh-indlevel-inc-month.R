...
### REPLICATION FILE: enigh-indlevel-inc-month.R
### R VERSION:        4.5+
### AUTHORS:          Matías Carrasco, Victor Ortega Le Hénanff
### DATE:             2026-05-02

### Builds the individual × month ENIGH panel for years 2016–2024.
### Parity port of enigh-indlevel-inc-month.do — must produce the same variable list,
...
write_dta_safe(panel, "../../data/clean/enigh/enigh-indlevel-inc-month.dta")
