...
### REPLICATION FILE: enigh-hhlevel-inc-year.R
### R VERSION:        4.5+
### AUTHORS:          Matías Carrasco, Victor Ortega Le Hénanff
### DATE:             2026-05-06

### Builds the household × year ENIGH income cross-section.
### Parity port of enigh-hhlevel-inc-year.do — see that file for the full design.
###
...
write_dta_safe(hh_panel, "../../data/clean/enigh/enigh-hhlevel-inc-year.dta")
